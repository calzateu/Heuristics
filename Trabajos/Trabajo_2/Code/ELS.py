...
def ELS(utils, problem_information, dist_matrix, demands, max_capacity, max_distance, num_cars, ni, nc, neighborhoods, generate_initial_solution=True, **kwargs):
    ...
    for j in range(ni):
        ...
        for k in range(nc):
            ...
            S, traveled_distances_S = VND(S, neighborhoods, dist_matrix, demands, max_capacity, max_distance, num_vehicles=num_cars, num_insertions=num_insertions, num_relocations=num_relocations, preprocess=False, traveled_distances=traveled_distances_S)
